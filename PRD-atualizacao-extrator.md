...
- [ ] B9c. **RETENÇÃO — decisão pendente do Dr. Alain.** Hoje o bucket **acumula para sempre**: nada apaga, nunca. Não é problema de disco (a ordem de grandeza é de GB/ano), é de LGPD — dado de saúde sem prazo de retenção definido. Precisa de um período (ex.: 1, 2, 5 anos) para virar regra de lifecycle no bucket. **Não implementado de propósito:** apagar documento de paciente é irreversível e o prazo é decisão clínica/jurídica, não default de engenharia
